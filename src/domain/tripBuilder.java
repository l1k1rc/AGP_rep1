...
public class tripBuilder {
	...
	public static ArrayList<Trip> tripBuilderAgent(ArrayList<Site> sites, ArrayList<Hotel> hotels, int minimal_price, int maximal_price, String confort){
		...
		Trip trip2 = new Trip(1, hotel1, listExcur1, 1022);
		Trip trip3 = new Trip(1, hotel1, listExcur1, 1022);
		Trip trip4 = new Trip(1, hotel1, listExcur1, 1022);
		Trip trip5 = new Trip(1, hotel1, listExcur1, 1022);
		Trip trip6 = new Trip(1, hotel1, listExcur1, 1022);
		Trip trip7 = new Trip(1, hotel1, listExcur1, 1022);
		Trip trip8 = new Trip(1, hotel1, listExcur1, 1022);
		Trip trip9 = new Trip(1, hotel1, listExcur1, 1022);
		Trip trip10 = new Trip(1, hotel1, listExcur1, 1022);
		Trip trip11 = new Trip(1, hotel1, listExcur1, 1022);

		ArrayList<Trip> listTrip = new ArrayList<Trip>();
		listTrip.add(trip1); listTrip.add(trip1); listTrip.add(trip1); listTrip.add(trip1); listTrip.add(trip1);
		listTrip.add(trip1); listTrip.add(trip1); listTrip.add(trip1); listTrip.add(trip1); listTrip.add(trip1);
		listTrip.add(trip1); listTrip.add(trip1);
